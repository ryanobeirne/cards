...
fn play_game() -> DealResult<(usize, usize, usize, usize)> {
    ...
    Ok((player, win_len, rounds, war_count))
}

fn round(game: &mut Game, war_count: &mut usize) -> DealResult<()> {
...
fn war(game: &mut Game, war_cards: &mut Vec<Card>) -> DealResult<()> {
